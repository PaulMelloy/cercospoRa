...
Included in the package is a weather dataset from a station adjacent to a sugar 
beet field trial.  
...
Now we can use the `epiphytoolR::format_weather()` function.  
