...
However EEEO dates in inoculated areas produced by remote sensing methods 
S2 and UAS were
`r interpret_gam(mod6_eo, 0,"sources2:inoculuminoculated")` and 
`r interpret_gam(mod6_eo, 0,"sourceuav:inoculuminoculated")` days 
`r interpret_gam(mod6_eo, 5,"sourceuas:inoculuminoculated")` than the observed EO days.  
